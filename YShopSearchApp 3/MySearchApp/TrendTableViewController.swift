...
class TrendTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    let entryUrl: String = "https://shopping.yahooapis.jp/ShoppingWebService/V1/type"
    ...
    // 呼出処理
    @IBAction func trendButtonTap(_ sender: UIButton, forEvent event: UIEvent) {
        // 保持している商品をいったん削除
